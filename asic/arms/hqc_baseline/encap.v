...
`endif	
    ...
    input u_v_in_wen,
	input [LOG_RAMDEPTH-1:0] u_v_in_addr,
...
localparam LOG_HASH_RD = `CLOG2(HASH_RAMDEPTH);
wire [LOG_HASH_RD-1:0] hash_addr;
reg [LOG_HASH_RD-1:0] h_addr;
reg [LOG_HASH_RD-1:0] hash_in_addr;

wire [31:0] m_out;
localparam LOG_M_WORDS = `CLOG2((K+(32-K%32)%32)/32);
wire [LOG_M_WORDS -1:0] msg_addr;
reg [LOG_M_WORDS -1:0] m_addr_int;
...
reg [LOG_RAMDEPTH-1:0] u_v_out_addr_int;
reg u_v_out_en_int;
reg sel_uv_int;
...
reg [LOG_HASH_RD-1:0] total_shake_input_count  = HASH_RAMDEPTH;
reg start_hash;
...
wire [LOG_RAMDEPTH-1:0] u_v_out_addr;
