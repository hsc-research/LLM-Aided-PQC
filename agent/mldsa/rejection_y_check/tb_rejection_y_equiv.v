// Lockstep equivalence TB: pristine rejection_y (REF) vs candidate (DUT).
`timescale 1ns / 1ps
module tb_rejection_y_equiv;
    ...
    rejection_y_ref REF (rst, clk, sec_lvl, valid_i, ri_ref, rdi, s_ref, vo_ref, ready_o);
    rejection_y     DUT (rst, clk, sec_lvl, valid_i, ri_dut, rdi, s_dut, vo_dut, ready_o);

    always #5 clk = ~clk;
    integer n, errors=0, checked=0, seed=32'hFACE03;
    ...
    begin
        ...
        for (n = 0; n < cycles; n = n + 1) begin
            ...
            if (n % 7 == 0) rdi <= (sec_lvl==2) ? {10'd0, 18'd131072, 18'd131073, 18'd131071}
                                                : {4'd0, 20'd524288, 20'd524289, 20'd524287}; // lanes at GAMMA_LIMIT-1/+1/exact
