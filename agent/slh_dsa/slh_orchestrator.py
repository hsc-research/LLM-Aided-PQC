...
def main():
    ...
    if g.returncode != 0:
        log({"block": block, "verdict": "abort",
             "reason": "pre-edit gate self-check FAIL: " + g.stdout.strip()[-200:]})
        sys.exit(1)
