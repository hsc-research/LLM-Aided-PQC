# Measure cycle count for poly_mult RAMWIDTH=64, HQC-128
create_project cycle_test_64 ./agent/cycle_test_64 -part xc7a200tfbg676-1 -force
...
add_files -norecurse {
    ...
    ./build/keygen/poly_mult_ramwidth64.v
}

set_property is_global_include true [get_files clog2.v]
update_compile_order -fileset sources_1

add_files -fileset sim_1 -norecurse ./agent/poly_mult_cycle_tb.v
