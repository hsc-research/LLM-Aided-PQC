# Measure cycle count for poly_mult baseline (RAMWIDTH=128, HQC-128)
create_project cycle_test_baseline ./agent/cycle_test_baseline -part xc7a200tfbg676-1 -force
...
add_files -fileset sim_1 -norecurse ./agent/poly_mult_cycle_tb_128.v
