...
| 2026-08-10_bf2x2_ooc_fmax | I/N | **SUPERSEDED 2026-08-12: four modules blackboxed, no number valid.** First block-level ASAP7 closure, butterfly2x2 OOC min period 578 ps, 8-point sweep with area and power. F15 only VIOLATED points reveal the limiter (Barrett), MET endpoints carry no information; F16 ripple-carry adder on path at 600 ps only; F17 578 vs 581 area inversion sets the measurement floor; F18 flop count invariant; F21 v1 script writes no .db |
